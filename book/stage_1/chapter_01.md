...
<img src="../../images/sheets/chapter_01.jpg" alt="第 1 章　三个套娃罢了——AI、机器学习与深度学习 · 四格漫画" width="100%">
...
```mermaid
flowchart LR
    A["1956 · AI 一词诞生<br/>达特茅斯会议<br/>(最外圈起点)"] --> B["1980s · 机器学习<br/>火成主流路线<br/>(中间圈起点)"]
    B --> C["2012 · 深度学习<br/>AlexNet 引爆<br/>(最内圈起点)"]
    C --> D["今天 · 大模型<br/>全面开花<br/>(住在最内圈)"]
```
...
```mermaid
flowchart TB
    subgraph AI["📦 大盒 · 人工智能 AI"]
        subgraph ML["📦 中盒 · 机器学习"]
            DL["📦 小盒 · 深度学习"]
        end
    end
    TRASH["🗑️ 废纸篓 · 根本不是 AI 的冒牌货"]
```
