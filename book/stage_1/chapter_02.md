...
<img src="../../images/sheets/chapter_02.jpg" alt="第 2 章 · 机器是怎么"学习"的——从写规则到喂数据 · 四格漫画" width="100%">
...
```mermaid
flowchart LR
    A["① 喂数据<br/>10 万封带标注"] --> B["② 模型先猜<br/>硬着头皮瞎猜一个"]
    B --> C["③ 对答案数错题<br/>'错了几封?' = 误差"]
    C --> D["④ 微调参数<br/>朝少错的方向拧一丢丢"]
    D -->|"转一圈进步一点点，但一秒能转几千圈"| B
```
