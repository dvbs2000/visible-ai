...
<img src="../../images/sheets/chapter_12.jpg" alt="第 12 章 · 预训练：吞下整个互联网的超级复读机 · 四格漫画" width="100%">
...
```mermaid
flowchart LR
    A["① 原料<br/>网页/书籍/代码<br/>数十万亿生数据"] --> B["② 清洗 ★最脏最值钱<br/>去重/去广告/过滤有害/配比"]
    B --> C["③ 分词<br/>切 token (第 11 章)"]
    C --> D["④ 训练<br/>猜下个词 ×上万亿次<br/>数月连转"]
    D --> E["⑤ 成品<br/>基座模型 (毛坯房)"]
```
